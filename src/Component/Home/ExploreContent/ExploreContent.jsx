...
const ExploreContent = () => {
    ...
    return (
        ...
        <div >
            ...
            <h1 className=" border-b-2 text-center md:text-5xl text-4xl font-[Poppins] lg:w-1/2 md:w-10/12 mx-auto lg:pt-20 pt-10">
                        Explore Contents
                        <br />
                        <span className='text-xl'>- Taking it to the Next Level -</span>
                    </h1>

              <div className="md:w-11/12 mx-auto overflow-y-auto" style={{ maxHeight: 'calc(100vh - 200px)' }}>
