                ...
                <div className="lg:flex justify-between rounded-lg">
                    ...
                    <div className="flex items-center justify-center md:w-10/12 w-11/12 mx-auto drop-shadow-lg">
                        ...
                        <div className="space-y-5 md:px-0 px-6">
                            ...
                            <div className="md:w-8/12 md:mx-0 w-11/12 mx-auto">
                                <Link to="/login">
                                    <button className="border-2 px-5 py-1 rounded-md bg-green-800 text-white" >sign up</button>
                                </Link>
                            </div>
                    ...
                    <div className="relative w-10/12 md:mr-20 py-24 hidden sm:hidden md:hidden lg:block xl:block">
                        ...
                        <div
                            ...
                            <div className="relative flex h-40 px-5 item-center  hover:bg-[#3c6e71] hover:text-white rounded">
                                <div className="absolute -top-10 left-12">
                                    <img className="w-12 h-12" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTa-e1xecZpad4VndJHeljUbClxpAuo77XFdw&usqp=CAU"></img>
                                </div>
                                <div>
                        ...
                        <div
                            ...
                            <div className="relative h-40 rounded-lg flex px-5 items-center  hover:bg-[#3c6e71] hover:text-white ">
                                <div className="absolute -top-10 left-12">
                                    <img className="w-16 h-16" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7OGSc0_RudC2_Of59g1ncHXsXnr_eHYChCg&usqp=CAU"></img>
                                </div>
                                <div>
                    ...
                    <div className="w-11/12 mx-auto py-10 space-y-3 lg:hidden md:block">
                        ...
                        <div className="hover:bg-[#3c6e71] duration-500 rounded-3xl p-5 https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTa-e1xecZpad4VndJHeljUbClxpAuo77XFdw&usqp=CAU">
                        ...
                        <div className="hover:bg-[#3c6e71] duration-500 rounded-3xl p-5">
                            <div className="flex justify-center">
                                <img className=" h-20" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7OGSc0_RudC2_Of59g1ncHXsXnr_eHYChCg&usqp=CAU" alt="" />
                            </div>
